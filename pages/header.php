    ...
    <nav>
        <header>
            ...
            <ul id="navbar" class="nav-menu">
                ...
                <li class="nav-item"><a href="about-us.php" class="nav-link"><i class="fa-solid fa-circle-info"></i>&nbsp;About us</a></li>
                ...
                <li class="nav-item"><a href="shopping-cart.php" class="nav-link"><i class="fa-solid fa-bag-shopping"></i>&nbsp;&nbsp;Cart <span
